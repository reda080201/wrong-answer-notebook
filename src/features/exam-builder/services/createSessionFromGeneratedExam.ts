...
export function createSessionFromGeneratedExam(exam: GeneratedExam, now = new Date(), options: { mode?: ExamMode; timeLimitMinutes?: number } = {}): ExamSession {
