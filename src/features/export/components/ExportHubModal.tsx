...
import { canonicalQuestionFingerprint, DEFAULT_QUESTION_PNG_OPTIONS, downloadQuestionPng, renderQuestionNodeToPng, type QuestionPngOptions } from "../services/questionPng";
...
export default function ExportHubModal(props: ExportHubModalProps) {
  ...
  const renderQuestionPng = async () => {
    ...
    try {
      ...
      setPngBlob(blob);
      setPngFingerprint(canonicalQuestionFingerprint(target.textContent ?? ""));
