...
interface KnowledgeGraphViewProps {
  ...
  onUpdateEntity(id: string, patch: Partial<Pick<KnowledgeEntity, "name" | "type" | "description" | "aliases">>): Promise<void>;
