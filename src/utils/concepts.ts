  ...
  return [
    ...new Set([
      ...
      ...(entry.answerKey ?? []).flatMap((item) => [
        ...
        ...extractConceptLinks(item.strategy ?? ""),
        ...(item.steps ?? []).flatMap(extractConceptLinks),
        ...(item.choiceJudgements ?? []).flatMap((judgement) => extractConceptLinks(judgement.text)),
        ...extractConceptLinks(item.wrongPoint ?? ""),
        ...extractConceptLinks(item.reviewPoint ?? ""),
